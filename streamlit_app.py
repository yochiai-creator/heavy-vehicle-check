...
CHECK_ITEMS = {
    "forklift": ["制動装置・操縦装置", "荷役装置・油圧装置", "車輪・タイヤ・外観", "警報装置・灯火類"],
    "vehicle": ["ブレーキ", "タイヤ", "灯火類・方向指示器", "油漏れ・水漏れ・外観"],
    "construction": ["ブレーキ・走行装置", "作業装置・油圧装置", "足回り・外観", "警報装置・灯火類"],
    "other": ["ブレーキ・操作装置", "作業装置・油圧装置", "足回り・外観", "警報装置・灯火類"],
    "backhoe": ["ブレーキ・走行装置", "作業装置・油圧装置", "足回り・外観", "警報装置・灯火類"],
    "dump": ["ブレーキ", "タイヤ", "灯火類・方向指示器", "油漏れ・水漏れ・外観"],
    "light_truck": ["ブレーキ", "タイヤ", "灯火類・方向指示器", "油漏れ・水漏れ・外観"],
    "wheel_loader": ["ブレーキ・走行装置", "作業装置・油圧装置", "足回り・外観", "警報装置・灯火類"],
}
